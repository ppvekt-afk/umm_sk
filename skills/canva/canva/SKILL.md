...
2026 Canva: **Canva AI 2.0** (editable design objects; Canva Design Model + gpt-image-2), **Magic Layers** (AI
image → editable layers; ~9M uses in month one; US/UK/CA/AU rollout), Dream Lab (Leonardo-powered), Bulk Create,
Magic Resize/Switch (150+ languages), Sheets/Charts, Video 2.0, and **Affinity base apps free** (AI behind Pro).
...
- **The agent** specs/drafts and — **where the Canva MCP/Connect APIs are connected** — creates/resizes/adapts
  ...
  "that looks great"). **Canva renders; WoopSocial publishes** the finished export (7 platforms, validation,
  queue, native analytics); Canva's own Content Planner exists — the split is a stack choice, stated honestly.
...
*system* this executes · **image-prompt / midjourney / ideogram / nano-banana / flux** = dedicated image
generation (drops into this workflow) · **ai-image-editing** (Wave 12) = the edit router (Magic Eraser/Expand/
