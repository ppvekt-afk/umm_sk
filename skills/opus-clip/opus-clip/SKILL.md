...
(read first; this file also carries the tool layer since no separate clipping.md tool file exists in the library)
· **descript** = the long-form talk edit (master there; its Underlord clip flags overlap) · **capcut** =
