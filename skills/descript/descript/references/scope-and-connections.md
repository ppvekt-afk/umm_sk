...
- **WoopSocial publishes** the finished exports (episode clips, social cuts) + reads native analytics. It does
...
- **captions-and-clipping / opus-clip** = clip selection at scale from long video (this feeds them the master;
  Underlord's clip flags overlap — cross-link when opus-clip ships).
