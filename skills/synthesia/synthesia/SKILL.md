...
- **A — Assemble scenes + localize:** brand kit + template once; AI Playground B-roll (Sora 2/Veo 3.1);
...
cap), **Video Agents** (real-time conversational; Enterprise), **AI Playground** (embedded Sora 2 + Veo 3.1
B-roll), Interactivity 2.0, AI Dubbing, Copilot, doc/PPT→video, SSML, ~real-time rendering, 39+ subtitle
