...
- **WoopSocial publishes** the finished images + reads native analytics; it does **not** edit, upscale, or
  remove backgrounds.
...
- **image-prompt / flux / nano-banana / ideogram / imagen** = image **generation** (new images from prompts);
