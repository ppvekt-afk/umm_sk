...
leads raw inpainting on complex masks (powers Photoshop Beta's Generative Fill); **Firefly** = licensed-training
...
ideogram / imagen** = generation (FLUX Kontext + nano-banana serve both lanes — this routes their *editing*
