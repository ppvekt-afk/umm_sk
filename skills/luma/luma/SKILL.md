...
description: >-
  ...
  router), veo-3/kling/runway (siblings; sound-native routes there), flux (the stills this animates), heygen/
...
model-agnostic router (read first) · **veo-3 / kling / runway** = siblings — **sound-native generation routes to
...
one-generation "film" promises**; and correctly distinguished from ai-video, veo-3/kling/runway, flux,
